...
from calender import CalenderTab
...
class TaskManagerApp:
    def __init__(self):
        ...
        self.calender_tab = CalenderTab(self)
        #.... add other tabs
    ...
    def create_navigation(self):
        ...
        ctk.CTkButton(
            ...
            text="Calender",
            width=120,
            command=lambda: self.show_tab("calender")
        ).pack(side="left", padx=5)
    ...
    def show_tab(self, tab_name):
        ...
        elif tab_name == "calender":
            self.current_tab = self.calender_tab
